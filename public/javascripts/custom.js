...
var ctx = document.getElementById('statisticsChartWeek').getContext('2d');
...
var myLegendContainer = document.getElementById("activeUsersChart");
...
function heart_week(){
	document.getElementById("Heart_week").style.display = "block"; 
		document.getElementById("Heart_month").style.display = "none"; 
...
function heart_month(){

	document.getElementById("Heart_week").style.display = "none"; 
	document.getElementById("Heart_month").style.display = "block"; 
	var ctx = document.getElementById('statisticsChartMonth').getContext('2d');
	...
	var statisticsChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [ {
				...
				fill: true,
				borderWidth: 2,
				data: [15, 184, 175, 203, 210, 231, 240, 278, 252, 312, 320, 374]
			}]
		},
		options : {
			responsive: true, 
